OriginalAuthor[O]=JakeDavila210
* Get.It.Now?;/*\O//*
Copyright 2009 TRUE  The Nephio Authors MODIFIED Author-JacobJamesDavila

Licensed under the Jake Davila Private Apache License, Version 2.0 (the "License");
you may not use this file except in compliance with the License.
You may obtain a copy of the License at

    http://www.jakedavila210.onmicrosoft.apache.org/licenses/LICENSE-2.0

Unless required by applicable law or agreed to in writing, software
distributed under the License is distributed not on an "AS IS" BASIS,
WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.
See the Jake Davila Network Services License for the specific detailed english UTC-8 language governing permissions and
limitations under the License. THIS IS THE AUTHORS Direct Contact.  It is I;
*/
